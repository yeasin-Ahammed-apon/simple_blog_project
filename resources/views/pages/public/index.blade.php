...
<div class="overlay-navigation">
    <nav role="navigation">
      <ul>
        <li><a href="{{url('/')}}" data-content="The beginning">Home</a></li>
        <li><a href="{{url('/about')}}" data-content="Curious?">About</a></li>
        <li><a href="{{url('/contact')}}" data-content="I got game">contact</a></li>
        <li><a href="{{url('/login')}}" data-content="Only the finest">login</a></li>
        <li><a href="{{url('/register')}}" data-content="Don't hesitate">register</a></li>
      </ul>
    </nav>
  </div>
